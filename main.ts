namespace SpriteKind {
    export const Objecto = SpriteKind.create()
    export const tesoro2 = SpriteKind.create()
    export const tesoro1 = SpriteKind.create()
    export const tesoro3 = SpriteKind.create()
}
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.tesoro1, function (sprite, otherSprite) {
    tesoro1.setImage(img`
    ...
    game.showLongText("Ganaste el primer tesoro: Juan 3:16", DialogLayout.Bottom)
    info.changeScoreBy(10)
    music.baDing.play()
    tesoro1.setFlag(SpriteFlag.AutoDestroy, false)
})
let tesoro3: Sprite = null
let tesoro2: Sprite = null
let tesoro1: Sprite = null
let Jony: Sprite = null
...
game.setDialogFrame(img`
    ...
    `)
game.setDialogTextColor(1)
game.showLongText("Encuentra el tesoro en el laberinto", DialogLayout.Bottom)
Jony = sprites.create(img`
    . . . . f f f f . . . . 
    . . f f e e e e f f . . 
    . f f e e e e e e f f . 
    ...
    . . . f f . . f f . . . 
    `, SpriteKind.Player)
Jony.setStayInScreen(true)
controller.moveSprite(Jony)
if (controller.A.isPressed()) {
    ...
    tesoro1 = sprites.create(img`
        ...
        b e e e e e c b b c e e e e 3 b 
        b e e e e e e e e e e e e e e b 
        b c e e e e e e e e e e e e c b 
        b b b b b b b b b b b b b b b b 
        . b b . . . . . . . . . . b b . 
        `, SpriteKind.tesoro1)
    tesoro1.setPosition(299, 105)
    ...
    tesoro3 = sprites.create(img`
        ...
        . b b . . . . . . . . . . b b . 
        `, SpriteKind.tesoro3)
    tesoro3.setPosition(240, 230)
    scene.cameraFollowSprite(Jony)
}
info.setScore(0)
